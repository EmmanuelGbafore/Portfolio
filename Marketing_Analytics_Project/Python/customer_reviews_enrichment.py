...
def fetch_data_from_sql():
    ...
    conn_str = (
        ...
        "Server=DESKTOP-UNTGQ2I\SQLEXPRESS;"  # Specify your SQL Server instance
...
customer_reviews_df.to_csv('C:/Data Analyst Project/fact_customer_reviews_with_sentiment.csv', index=False)
